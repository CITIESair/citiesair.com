...
export const useEditAlertMutation = () => {
    ...
    return useMutation({
        mutationFn: async ({ alertToEdit }) => {
            const url = getAlertsApiUrl({
                endpoint: GeneralAPIendpoints.alerts,
                school_id: currentSchoolID,
                alert_id: alertToEdit[AirQualityAlertKeys.id]
            });
