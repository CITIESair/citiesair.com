...
export type CurrentAQIGridSizeType = typeof CurrentAQIGridSize[keyof typeof CurrentAQIGridSize];

interface ElementSize {
  icon: string | null;
  locationAndCategory: Variant;
  aqi: Variant;
  aqiLineHeight: number;
  sensorStatus: Variant;
  heatIndex: Variant;
  meteroDataMarginTop: number;
  metero: Variant;
  rawValues: Variant;
  importantFontWeight: string | null;
  aqiScaleText: Variant;
  aqiScaleHeight: string;
  aqiScaleWidth: string;
}

export const ElementSizes: Record<CurrentAQIGridSizeType, ElementSize> = {
