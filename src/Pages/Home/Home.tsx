...
import { Button, Box, Grid, Typography, Container, Divider, useMediaQuery, Theme } from '@mui/material';
...
import useCurrentSensorsData, { CurrentSensorsData } from '../../hooks/useCurrentSensorsData';
